...
const TrustBar = () => {
    return (
        <div className="w-full bg-gradient-to-r from-background via-border/5 to-background relative backdrop-blur-md overflow-hidden py-4 border-y border-border/5">
            ...
            <div className="flex relative w-full overflow-hidden mask-gradient-x">
                ...
                >
                    {[...items, ...items, ...items, ...items].map((item, idx) => (
                        <div key={idx} className="flex items-center gap-3 text-muted font-mono text-sm tracking-widest uppercase">
