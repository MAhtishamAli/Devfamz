...
const Hero = () => {
    ...
    return (
        <section
            id="home"
            className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 md:pt-20 bg-background text-foreground transition-colors duration-300"
        >
            {/* ── Particle Morph Background ── */}
            <div className="absolute inset-0 z-0 overflow-hidden">
                {/* Gradient fade at bottom so content blends */}
                ...
                {/* Theme-aware dim layer — lighter so animation shines through */}
                <div className="absolute inset-0 bg-background/30 z-10 pointer-events-none" />

                {/* The actual canvas animation */}
                <NeuralCanvas />
            </div>
            ...
            <div className="container mx-auto px-6 relative z-20 flex flex-col md:flex-row items-center gap-12 md:gap-20">
                ...
                >
                    <h1 className="text-4xl md:text-7xl font-bold tracking-tight mb-6 leading-tight text-foreground font-sans">
                        Architecting the <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary animate-text-shimmer">
                            Intelligence Layer.
                        </span>
                    </h1>
                ...
                >
                    <div className="relative p-1 bg-gradient-to-br from-cyan-200/60 to-blue-300/60 dark:from-primary/50 dark:to-secondary/50 rounded-2xl backdrop-blur-3xl">
                        <div className="absolute inset-0 bg-primary/10 blur-3xl -z-10 animate-pulse-slow" />
